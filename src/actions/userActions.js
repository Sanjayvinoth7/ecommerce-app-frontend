...
export const registerNewUser=(user)=>dispatch=>{
   ...
   axios
     .post(`${config.api}/api/users/register` , user)
     .then(res => {
...
export const loginUser=(user)=>dispatch=>{
  ...
  axios
    .post(`${config.api}/api/users/login` , user)
    .then(res => {
...
export const updateUser=(userid , updateduser)=>dispatch=>{
  ...
  axios
    .post(`${config.api}/api/users/update` , {userid : userid , updateduser : updateduser})
    .then(res => {
...
export const getAllUsers=()=>dispatch=>{
    ...
    axios.get(`${config.api}/api/users/getallusers`).then(res=>{
...
export const deleteUser=(userid)=>dispatch=>{
   ...
   axios.post(`${config.api}/api/users/deleteuser` , {userid}).then(res=>{
